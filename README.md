...
---
## 📋 Sobre o Projeto:
O projeto foi está dividido 3 partes:

| Propósito | Link |
|---|---|
| Programação do FPGA e ESP32 | https://github.com/Ricciow/Embarcados/ | 
| Backend do aplicativo (repositório atual) | https://github.com/LernerLior/projetoEmbarcados| 
...
| Propósito | Link |
|---|---|
| Download da documentação técnica | https://drive.google.com/drive/folders/1yBeXkIWZ1yUI2G5Az3jE6LyOPoE5jVPC?hl=pt-br&q=sharedwith:public%20parent:1yBeXkIWZ1yUI2G5Az3jE6LyOPoE5jVPC | 

---
## 📼 Link de acesso ao vídeo do sistema em execução:
